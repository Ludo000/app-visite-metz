...
public class SitesFavorisProvider extends ContentProvider {

    private SQLiteDatabase db;

    static final String PROVIDER_NAME = "com.example.sami.visitmetz_v2.ContentProvider.SitesFavorisProvider";
    static final String URL = "content://" + PROVIDER_NAME + "/SitesFavoris_table";
    public static final Uri CONTENT_URI = Uri.parse(URL);
    // nom de la table site
    static final String Table_Site = "SitesFavoris_table";
    ...
    private static HashMap<String, String> SITES_FAVORIS_PROJECTION_MAP;
