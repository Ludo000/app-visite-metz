...
public abstract class MyCursorAdapter_2<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public MyCursorAdapter_2(Context context, Cursor cursor) {
        this.mContext = context;
        this.mCursor = cursor;
        this.mDataValid = cursor != null;
        this.mRowIdColumn = this.mDataValid ? this.mCursor.getColumnIndex("_idFavoris") : -1;
    ...
    public static final String TAG = MyCursorAdapter_2.class.getSimpleName();
    ...
    public Cursor swapCursor(Cursor newCursor) {
        ...
        if (this.mCursor != null) {
            ...
            this.mRowIdColumn = newCursor.getColumnIndexOrThrow("_idFavoris");
    ...
    private class NotifyingDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            super.onChanged();
            ((MyCursorAdapter_2) this.adapter).setDataValid(true);
        ...
        public void onInvalidated() {
            super.onInvalidated();
            ((MyCursorAdapter_2) this.adapter).setDataValid(false);
        }
    }
}
